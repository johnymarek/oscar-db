...
<mediaDisplay name=meleThreePartView
   ...
   suffixClearImage="/tmp/app/www/modules/oscar-db/images/ch5.jpg"
...
if ($db = new PDO("sqlite:$dbname")) {
	...
	if ($query === false) {
		...
		echo "<link>http://127.0.0.1:8002/modules/oscar-db/updateradio.php</link>\n";
		echo "</item>\n\n";
	} else {
		...
		while ($row = $r->fetch(SQLITE_ASSOC)) {
			...
			echo "<link>http://127.0.0.1:8002/modules/oscar-db/list_a.php?g=".$tmpg."</link>\n";
			echo "</item>\n\n";
		  }
		...
		while ($row = $r->fetch(SQLITE_ASSOC)) {
			...
			echo "<link>http://127.0.0.1:8002/modules/oscar-db/list_a.php?c=".$tmpc."</link>\n";
			echo "</item>\n\n";
		  }
		...
		echo "<link>http://127.0.0.1:8002/modules/oscar-db/list_a.php?f=0</link>\n";
		echo "</item>\n\n";
		
		echo "<item>\n";
		echo "<title>Search</title>\n";
		echo "<link>rss_command://search</link>\n";
		echo "<search url='http://127.0.0.1:8002/modules/oscar-db/list_a.php?s=%s' />\n";
		echo "</item>\n\n";
		 
		echo "<item>\n";
		echo "<title>Genres</title>\n";
		echo "<link>http://127.0.0.1:8002/modules/oscar-db/index_a.php?m=g</link>\n";
		echo "</item>\n\n";

		echo "<item>\n";
		echo "<title>Countries</title>\n";
		echo "<link>http://127.0.0.1:8002/modules/oscar-db/index_a.php?m=c</link>\n";
		echo "</item>\n\n";
